 ...
 */
final class Version20210509223526 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_37D4778EA76ED395 ON enseigne (user_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_37D4778EA76ED395 ON enseigne');
